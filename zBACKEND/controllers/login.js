...
module.exports.donate=(req,res,next)=>{
    var det = new Donations({
                   
        donateitem:req.body.donateitem,
       name:req.body.name,
       age:req.body.age,
...
module.exports.showdon=(req,res,next)=>{    
    Donations.find().then(function(details){
            res.send(details);
            console.log(details);
...
module.exports.locationsearch=(req,res,next)=> {
    console.log(req.body.location);
  Donations.find({ place:req.body.location ,donateitem:req.body.type} ,(err, items) => {
      console.log(items);
